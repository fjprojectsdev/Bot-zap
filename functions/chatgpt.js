...
async function callOpenRouter(messages) {
    const response = await secureFetch('https://openrouter.ai/api/v1/chat/completions', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
